...
public class EnterpriseySearcherTest {
    ...
    @Test
    void testPerformRRF_StandardCase() {
        // Given
        ...
        // When
        List<CatalogueItem> result = EnterpriseySearcher.performRRF(List.of(list1, list2), 60, 10);
    ...
    @Test
    void testPerformRRF_EmptyLists() {
        // Given
        ...
        // When
        List<CatalogueItem> result = EnterpriseySearcher.performRRF(emptyLists, 60, 10);
    ...
    @Test
    void testPerformRRF_NullInListOfLists() {
        // Given
        ...
        assertThrows(NullPointerException.class, () -> 
            EnterpriseySearcher.performRRF(listsWithNull, 60, 10)
        );
    }

    @Test
    void testPerformRRF_TwoLists() {
        // Given
        List<CatalogueItem> list1 = List.of(
    ...
    @Test
    void testPerformRRF_ThreeLists() {
        // Given
        List<CatalogueItem> list1 = List.of(
            createItem("apple", "1.00", "USD"),
            createItem("banana", "2.00", "USD")
        ...
        // When
        List<CatalogueItem> result = EnterpriseySearcher.performRRF(List.of(list1, list2, list3), 60, 10);
    ...
    void testPerformRRF_OneList() {
        ...
        // When
        List<CatalogueItem> result = EnterpriseySearcher.performRRF(List.of(list), 60, 10);
    ...
    @Test
    void testPerformRRF_RankWindowSize() {
        // Given
        List<CatalogueItem> list = List.of(
            createItem("apple", "1.00", "USD"),
            createItem("banana", "2.00", "USD"),
        ...
        List<CatalogueItem> result = EnterpriseySearcher.performRRF(List.of(list), 60, 3);
    ...
    @Test
    void testPerformRRF_DifferentKValue() {
        // Given
        List<CatalogueItem> list1 = List.of(
        ...
        List<CatalogueItem> resultK1 = EnterpriseySearcher.performRRF(List.of(list1, list2), 1, 10);

        // When - with k=100 (lower impact of rank)
        List<CatalogueItem> resultK100 = EnterpriseySearcher.performRRF(List.of(list1, list2), 100, 10);
